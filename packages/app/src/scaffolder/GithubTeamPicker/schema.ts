...
export type GithubTeamPickerFilterQuery = z.TypeOf<
  typeof githubTeamQueryFilterExpression
>;

export type GithubTeamPickerFilterQueryValue =
  GithubTeamPickerFilterQuery[keyof GithubTeamPickerFilterQuery];
